...
void draw()  {  
  ...
  fill(255,140,50);
  stroke(255,140,50);
  ellipse(400,400,c2,c2);

  fill(255,88,77);
  stroke(255,88,77);
  ellipse(400,400,c3,c3);

  fill(239,77,66);
  stroke(239,77,66);
  ellipse(400,400,c4,c4);

  fill(222,60,59);
  stroke(239,77,66);
  ellipse(400,400,c5,c5);

  fill(222,100,49);
  stroke(222,100,49);
  ellipse(400,400,c6,c6);

  fill(222,120,49);
  stroke(222,120,49);
  ellipse(400,400,c7,c7);

  fill(222, 136, 49);
  stroke(222, 136, 49);
  ellipse(400,400,c8,c8);
    
    
 
 if (c10 >= 1100) { /// controls sharkos origine / 0,0
   c10 = 100;
 }
...
y6= y6 + 2;
  ...
  pushMatrix();
  translate(sharkox, 0 );   /// origine points 
  sharko();
  popMatrix();
...
int c1 = 1100; //variable for background circle
int c2 = 1000;
int c3 = 900;
int c4 = 800;
int c5 = 700;
